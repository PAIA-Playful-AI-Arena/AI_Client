"""
created_at_utc  : 2023-05-17T02:09:35Z
created_at_w3c  : 2023-05-17T10:09:35+08:00
PAIA-Desktop    : 2.4.3
MLGame          : 10.2.8
game            : dont_touch
game_version    : 1.0.1
...
class MLPlay:
    ...
    def update(self, scene_info, keyboard=[], *args, **kwargs):
        ...
        if scene_info['status'] != "GAME_ALIVE":
            ...
            # 一定要根據特徵資料收集的順序和項目喔!
            _E7_89_B9_E5_BE_B5_E8_B3_87_E6_96_99 = [[scene_info['L_sensor'], scene_info['L_T_sensor'], scene_info['F_sensor'], scene_info['R_T_sensor'], scene_info['R_sensor'], scene_info['B_sensor']]]
