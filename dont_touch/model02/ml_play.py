"""
created_at_utc  : 2023-05-22T12:21:04Z
created_at_w3c  : 2023-05-22T20:21:04+08:00
PAIA-Desktop    : 2.4.3-competition
MLGame          : 10.2.8
game            : dont_touch
game_version    : 1.0.0
"""
...
class MLPlay:
    ...
    def update(self, scene_info, keyboard=[], *args, **kwargs):
        ...
        if scene_info['status'] != "GAME_ALIVE":
            ...
            # 一定要根據特徵資料收集的順序和項目喔!
            _E7_89_B9_E5_BE_B5_E8_B3_87_E6_96_99 = [[scene_info['L_T_sensor'], scene_info['F_sensor'], scene_info['R_T_sensor']]]
